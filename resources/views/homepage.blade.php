                                ...
                                <div class="md:h-auto w-full flex justify-center md:justify-end items-center w-2/3 shadow-md shadow-gray-200 flex rounded-lg p-4">
                                    <div class="h-full flex ">
                                        ...
                                        <div class="h-auto w-full p-2 items-center">
                                            <h1 class="text-lg md:text-xl text-red-800 tracking-wide">Title Here </h1>
                            ...
                            <div class="w-full md:flex gap-x-14 mb-5">
                                <div class="md:h-auto w-full flex justify-center md:justify-end items-center w-2/3 shadow-md shadow-gray-200 flex rounded-lg p-4">
                                    <div class="h-full flex ">
                                        ...
                                        <div class="h-auto w-full p-2 items-center">
                                            <h1 class="text-lg md:text-xl text-red-800 tracking-wide">Title Here </h1>
                                            <p class="h-full text-base md:text-lg text-justify text-black leading-tight md:leading-relaxed line-clamp-3 md:line-clamp-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor. dolor sit amet, consectetur adipiscing adipiscing </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="md:h-auto w-full flex justify-center md:justify-end items-center w-2/3 shadow-md shadow-gray-200 flex rounded-lg p-4">
                        ...
                        <div class="h-2/3 md:h-2/4 w-full md:flex md:justify-around md:items-center md:gap-x-12 mt-0 md:mt-5 lg:mt-5">
                            <div class="w-full h-full  md:flex gap-x-14 mb-6">
                                ...
                                <!-- IMAGE HERE -->
                                    ...
                                    <p class="text-lg lg:text-xl text-red-800 font-montserrat ml-2 mt-2">Title Here</p>
                                    <p class="text-justify ml-2 mr-2 mt-2 text-base md:text-lg font-montserrat">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    <div class="w-full  flex justify-start lg:justify-center ml-2 lg:ml-0 mb-2 text-sm md:text-base">
                                        <button class="border text-white bg-black mt-2 mb-2 h-8 md:h-10 w-24 md:w-32 rounded-md hover:bg-danger">Read More</button>
                                    </div>
                                </div>
                                <div class="h-auto lg:h-auto lg:w-auto mt-5  w-full  rounded-2xl shadow-lg shadow-gray-200" >
                                <!-- IMAGE HERE -->
                                ...
                                <!-- IMAGE HERE -->
                                    ...
                                    <div class="h-auto">
                                        <p class="text-lg lg:text-xl  text-red-800 font-montserrat ml-2 mt-2">Title Here</p>
                                        <p class="text-justify ml-2 mr-2 mt-2 text-base md:text-lg-base font-montserrat">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                        <div class="w-full flex justify-start lg:justify-center ml-2 lg:ml-0 mb-2 text-sm md:text-base">
                                            <button class="border text-white bg-black mt-2 mb-2 h-8 md:h-10 w-24 md:w-32 rounded-md hover:bg-danger">Read More</button>
                                        </div>
                                    </div>
                            ...
                            <div class="article">
                                <div class="wrapper">
                                    <ul class="marquee marquee flex justify-between items-center gap-3 items-center">
                                        ...
                                        <li class="-mr-5">
                                            <img src="img/partnerships/partnership4.png" alt="4" class="small-img">
                                        </li>
                                        <li>
