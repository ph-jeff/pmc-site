                        ...
                        <div class="w-4/5">
                            ...
                            <form action="">
                                    ...
                                    <div class="w-full mt-4 md:mt-0">
                                        <label class="font-montserrat text-base" name="Phone Number:">Message<span class="text-red-500">*</span></label>
                                        <textarea class="h-20 w-full border-2"></textarea>
                                    </div>
                                    <div class=" w-full flex justify-center my-5">
                                        <a class="font-montserrat font-bold text-normal h-2/4 w-36 bg-black text-white p-2 md:p-3 flex justify-center items-center" href="" type="submit">SUBMIT</a>
                                    </div>
                                </div>
                            </div>
                        </form>
