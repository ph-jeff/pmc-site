    ...
    <div class="flex w-full h-20 justify-center items-center">
        <div class="w-11/12 md:w-11/12 lg:w-9/12 flex justify-between content-center">
            ...
            <ul class="flex gap-1 text-center items-center">
                ...
                <a class="text-white text-base font-semibold" href="/news"><li class="h-12 w-20 flex justify-center items-center bg-danger"> News </li></a>
                            ...
                            <div class="w-full h-auto md:h-38 flex flex-row">
                                ...
                                <div class="">
                                    ...
                                    <div class="flex justify-end md:bottom-2 md:right-2 mt-1 md:mt-4">
                                        <a href="/home-news" class="flex justify-center items-center text-white bg-black h-8 md:h-9 w-24 md:w-30 rounded hover:bg-danger text-xs md:text-sm">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full h-auto md:h-38 flex flex-row">
